...
public class Main extends Application {
	...
	public void start(Stage window) throws Exception {
		...
		Button helpButton = new Button("Help");
			helpButton.setEffect(dshadow);
			helpButton.setStyle("-fx-font: 15 arial; -fx-base: #ed1c24;");

			helpButton.setOnMouseEntered(event -> select.play());
			helpButton.setOnMouseExited(e -> select.stop());
		...
		//create a border pane for the menu scene
  		BorderPane menu = new BorderPane();
			...
			vbox.getChildren().addAll(menuTitle, playButton, optionsButton, helpButton, muteButton, exitButton);
		...
		help = new HelpMenu(window,mainMenu);
		helpMenu = new Scene(help.getPane(), 440,440,Color.LIGHTGRAY);
		...
		optionsButton.setOnMousePressed(e -> click.play());
      	...
      	helpButton.setOnMousePressed(e -> click.play());
      		helpButton.setOnMouseReleased(e ->{ 
      		click.stop();
      		window.setScene(helpMenu); //Switch to help menu
      		});
